...
included_letters = ['C', 'D', 'E', 'F', 'G']
c = [name.name for name in humans if (name.name[0] in included_letters)]
print(c)
...
e = [(name.name + '-' + str(name.age)) for name in humans]
print(e)
...
f = [(name.name, name.age) for name in humans if (27 <= name.age and name.age <= 32)]
print(f)
